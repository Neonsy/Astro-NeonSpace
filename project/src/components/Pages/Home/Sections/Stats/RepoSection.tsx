            ...
            <div className='grid grid-cols-1 gap-4 lg:grid-cols-3'>
                {repos.map((repo) => (
                    <motion.div
                        ...
                        className='group flex flex-col gap-y-6 rounded-xl border border-white/10 bg-white/[0.03] p-6 transition-all duration-200 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.05] lg:backdrop-blur-sm'>
